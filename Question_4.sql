...
SELECT a.payroll_year, salary_year_Change, commodities_price_year_change
FROM (
SELECT
	payroll_year,
...
GROUP BY
	payroll_year) b 
where  a.payroll_year=b.payroll_year
AND commodities_price_year_change  > salary_year_Change + 10